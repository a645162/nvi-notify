...
from feature.api import api_data_common
...
def get_nvitop_output() -> flask.Response:
    command_result = api_data_common.get_nvitop_result()
...
def post_machine_user_message() -> flask.Response:
    ...
    if flask.request.method == "POST":
        ...
        api_data_common.machine_user_message_backend(
            user_name=user_name,
            content=content,
        )
...
def get_system_info() -> flask.Response:
    system_info: dict = api_data_common.get_system_info_dict()
...
def get_gpu_count() -> flask.Response:
    gpu_count = api_data_common.get_gpu_count_backend()
...
def get_gpu_usage_info() -> flask.Response:
    ...
    if gpu_index is None or gpu_index > api_data_common.get_gpu_count_backend():
        return flask.Response(
    ...
    response_gpu_usage = api_data_common.get_gpu_usage_dict(gpu_index=gpu_index)
...
def get_gpu_task_info() -> flask.Response:
    ...
    task_list = api_data_common.get_gpu_task_dict_list(gpu_index=gpu_index)
...
def get_disk_usage() -> flask.Response:
    result = api_data_common.get_disk_usage_dict_list()
...
def get_disk_usage_user() -> flask.Response:
    result = api_data_common.get_disk_usage_user_dict_list()
